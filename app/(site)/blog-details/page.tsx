...
export const metadata: Metadata = {
  title: "Medical Blog Details Page",
  description: "This is a Medical blog details page providing insights on health and wellness.",
  // other metadata
};
              ...
              <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
                <div className="mb-10 w-full overflow-hidden ">
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                    <Image
                      src={"/images/blog/blog-01.png"}
                      alt="Understanding Heart Health"
                      fill
                      className="rounded-md object-cover object-center"
                    />
                  </div>
                ...
                <div className="blog-details">
                  <p>
                    Cardiovascular health is a critical component of overall
                    wellness. Regular exercise, a balanced diet, and stress
                    management play vital roles in maintaining a healthy heart.
                  </p>

                  <p>
                    Recent studies highlight the benefits of a Mediterranean
                    diet, rich in fruits, vegetables, and whole grains, for
                    reducing the risk of heart diseases. Incorporating
                    mindfulness practices can further enhance well-being.
                  </p>
                  ...
                  <p>
                    Routine checkups help in early detection and prevention of
                    potential health issues. Stay proactive in consulting your
                    healthcare provider to ensure a long, healthy life.
                  </p>
                </div>
